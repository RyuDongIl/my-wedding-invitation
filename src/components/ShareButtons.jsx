...
export default function ShareButtons() {
  ...
  return (
    <section className="px-8 pb-14 pt-2 text-center">
      <div className="mx-auto grid max-w-[340px] grid-cols-2 gap-3">
        ...
        <button
          ...
          className="rounded-sm bg-[#FEE500] py-3 text-xs font-medium tracking-wide text-[#3A1D1D] transition hover:bg-[#F7DC00]"
        >
          카카오톡 공유
        </button>
      </div>
