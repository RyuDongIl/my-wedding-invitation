...
const VENUE_POSITION = { lat: 37.4577143, lng: 126.9538638 };
const KAKAO_MAP_URL = `https://map.kakao.com/link/to/${encodeURIComponent(VENUE_NAME)},${VENUE_POSITION.lat},${VENUE_POSITION.lng}`;
    ...
    loadKakaoMapSdk()
      .then((kakao) => {
        kakao.maps.load(() => {
          ...
          const position = new kakao.maps.LatLng(VENUE_POSITION.lat, VENUE_POSITION.lng);
